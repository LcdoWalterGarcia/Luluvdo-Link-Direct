<?php
$filelink="https://luluvdo.com/e/vfdjmsjt40jc";
if (strpos($filelink,"luluvdo.") !== false) {
  ...
  if (preg_match("/sources\:\[\{file\:\"([^\"]+)\"/",$out,$m))
    $link=$m[1];
   if ($link && $flash <> "flash")
    $link=$link."|Referer=".urlencode("https://luluvdo.com")."&Origin=".urlencode("https://luluvdo.com");
}
echo $link;
?>
